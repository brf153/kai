...
class TestLoggingSetup(unittest.TestCase):
    ...
    def test_setup_file_handler(self, mock_file_handler):
        ...
        setup_file_handler(logger, self.log_file, self.test_log_dir, self.file_log_level)
        mock_file_handler.assert_called_once_with(os.path.join(self.test_log_dir, self.log_file))
    ...
    def test_init_logging(self):
        initLogging(self.console_log_level, self.file_log_level, self.test_log_dir, self.log_file)
